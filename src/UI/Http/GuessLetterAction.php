...
use App\UI\Http\Validator\GuessLetterInputValidator;
...
final class GuessLetterAction
{
    ...
    private GuessLetterInputValidator $guessLetterInputValidator;

    public function __construct(
        GuessLetterResponder $guessLetterResponder,
        GuessLetterInputValidator $guessLetterInputValidator,
