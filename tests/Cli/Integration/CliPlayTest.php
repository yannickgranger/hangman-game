...
class CliPlayTest extends TestCase
{
    ...
    {
        $game = new HangmanGame('secret', 6,5);
    ...
    {
        $game = new HangmanGame('hello', 6,5);
    ...
    {
        $game = new HangmanGame('hello',4,5);
    ...
    {
        $game = new HangmanGame('world', 4,5);
